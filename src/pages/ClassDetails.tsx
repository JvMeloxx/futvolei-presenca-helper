...
import { getClassDetailsById, getClassParticipants, toggleClassConfirmation, ClassDetails as ClassDetailsType, ClassParticipant } from '@/models/ClassConfirmation';
  ...
  useEffect(() => {
    const loadClassDetails = async () => {
      ...
      try {
        ...
        // Load real participants from database instead of mocking
        try {
          const realParticipants = await getClassParticipants(id);
          setParticipants(realParticipants);
        } catch (err) {
          console.error("Failed fetching participants, fallbacking to empty array", err);
          setParticipants([]);
        }
